Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/salute-developers/jazz-ios-sdk.git', tag: 'v25.3.1' }
  spec.ios.vendored_frameworks = 'Sources/JazzSDK.xcframework', 'Sources/LibSberCast.xcframework', 'Sources/JazzCore.xcframework', 'Sources/WebRTC.xcframework', 'Sources/JazzSDKScreenShare.xcframework', 'Sources/Spench.xcframework'
