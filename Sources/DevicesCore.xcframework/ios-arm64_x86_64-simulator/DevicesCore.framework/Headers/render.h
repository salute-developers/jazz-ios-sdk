...
void sddc_cmark_render_ascii(cmark_renderer *renderer, const char *s);

void sddc_cmark_render_code_point(cmark_renderer *renderer, uint32_t c);

char *sddc_cmark_render(cmark_node *root, int options, int width,
