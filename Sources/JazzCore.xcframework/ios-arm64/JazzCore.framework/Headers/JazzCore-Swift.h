...
#ifndef JAZZCORE_SWIFT_H
#define JAZZCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JazzCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP8JazzCore17JMCallKitListener_")
...
SWIFT_CLASS("_TtC8JazzCore14JMCallKitProxy")
